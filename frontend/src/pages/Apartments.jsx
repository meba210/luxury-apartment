        ...
        <div className="container">
          <div className="apartments-page__header-content">
            ...
            <p className="apartments-page__subtitle">
              Browse our curated collection of premium residences, duplexes and
              penthouses
              <br />
          ...
          {loading ? (
            ...
            <div className="apartments-page__state">
              ...
              <button
                ...
                onClick={() => fetchApartments(filters)}
              >
                Try Again
              </button>
            </div>
            ...
            <>
              ...
              {hasMore && (
                <div className="apartments-page__load-more">
                  ...
                  >
                    Load More Properties ({apartments.length - paginated.length}{' '}
                    remaining)
                  </button>
                </div>
              )}
